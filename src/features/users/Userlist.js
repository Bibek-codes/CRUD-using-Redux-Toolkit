...
const Userlist = () => {
    // const users = [{
    //   id:'1' , name: 'Amanda' , email:'amanda07@gmail.com'
    // },{
    //   id:'2' , name: 'John' , email:'john07@gmail.com'
    // }];
  ...
  return (
    ...
    <div className='grid gap-5 md:grid-cols-2'>
      {users.length ? renderCard() : <p className='text-center col-span-2 
      text-gray-700 font-semibold'>No User</p>}
    </div>
    </div>
  )
}
